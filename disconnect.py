...
def setup(client):
    ...
    @client.command(aliases=['desligar', 'desconectar'], hiddden=True, help=f'\"{bot_prefix}kill *motivo*\" Me desliga pelo motivo especificado. Somente Programadores podem utilizá-lo.')
