...
class Reports(commands.Cog):
    ...
    async def reports(self, ctx):
        ...
        embed.add_field(name='Denúncia privada', value=f'Clique no botão abaixo para criar um ticket e fazer uma reclamação/denúncia. Somente usuários <@&{cargos.admin_roles_id[0]}> terão acesso ao canal criado para que você faça sua denúncia.', inline=False)
